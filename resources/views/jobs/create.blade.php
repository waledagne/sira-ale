<x-layout>
    ...
    @csrf
          ...
          <x-inputs.select id="job_type" name="job_type" label="Job Type" value="{{ old('job_type') }}" :options="['Full-Time' => 'Full-Time', 'Part-Time' => 'Part-Time', 'Contract' => 'Contract',
            ...
            <x-inputs.text-area id="company_description" name="company_description" label="Company Description" placeholder='Description' />
            <x-inputs.text id="company_website" name="company_website" label="Company Website" placeholder='https://example.com' type='url'/>
